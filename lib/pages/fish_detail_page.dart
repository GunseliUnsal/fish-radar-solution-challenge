        ...
        child: Column(
          ...
          children: [
            CachedNetworkImage(
              ...
              placeholder: (context, url) => Image.asset("assets/png/placeholder.png"), // Placeholder widget
              errorWidget: (context, url, error) =>
                  Image.asset("assets/png/placeholder.png"), // Error widget if image fails to load
              height: 200,
