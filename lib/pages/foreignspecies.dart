    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          bool alreadyClicked = prefs.getBool('foreignSpeciesClicked') ?? false;

          if (!alreadyClicked) {
            // Call the callback with the current progress
            onComplete(0.166);
            prefs.setBool('foreignSpeciesClicked', true);
