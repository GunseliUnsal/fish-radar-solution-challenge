...
class HumanImpact extends StatelessWidget {
  ...
  const HumanImpact({Key? key, required this.onComplete}) : super(key: key);
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          bool alreadyClicked = prefs.getBool('humanImpactClicked') ?? false;

          if (!alreadyClicked) {
            // Call the callback with the current progress
            onComplete(0.166);
            prefs.setBool('humanImpactClicked', true);
